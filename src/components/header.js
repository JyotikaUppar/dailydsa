...
export default function Header() {
  return (
    <header>z
      <nav className="-10 w-full absolute">
        <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
          <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
            ...
            <div className="flex items-center space-x-2">
              ...
              <img src={Logo?.src ?? Logo} className="h-14 w-40" alt="Logo" />
              </div>
            ...
            >
              <div className="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
                <ul className="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
                  <li>
                    <Link href="/problems" className="block md:px-4 transition hover:text-primary">
                      <span>Problems</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/discuss" className="block md:px-4 transition hover:text-primary">
                      <span>Discuss</span>
                    </Link>
                  </li>
                  <li>
                    <Link href="/contest" className="block md:px-4 transition hover:text-primary">
                      <span>Contest</span>
                    </Link>
                  </li>
                  <li>
