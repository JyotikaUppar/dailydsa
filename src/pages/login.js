      ...
      >
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4 mb-6">
          ...
          <button
            disabled={loading}
            type="submit"
            className="w-full bg-primary hover:bg-violet-500 text-white font-bold py-3 px-4 rounded-xl transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2 group"
          >
        ...
        <p className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link href="/signup" className="text-primary hover:text-white font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </motion.div>
